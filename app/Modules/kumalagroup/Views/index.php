...
<body id="page-top">
    <nav class="navbar navbar-expand-lg bg-secondary shadow fixed-top" id="mainNav">
        <a href="<?= base_url() ?>"><img src="<?= base_url() ?>/assets/baru/img/logo.png" style="margin-left: 15px;" alt="Logo" width="160px" height="60px"></a>
        ...
        <div class="collapse navbar-collapse" id="navbarResponsive">
            <ul class="navbar-nav ml-auto">
                            ...
                            <div class="row">
                                <div class="col-sm-6 col-lg-3">
                                    ...
                                    <ul type="square">
                                        ...
                                        <li><a class="dropdown-item" href="https://honda-kmg.000webhostapp.com/">Honda</a></li>
                ...
                <?php endif ?>
                <li class="nav-item mx-0 mx-lg-1">
                    <a class="nav-link py-3 px-0 px-lg-3 rounded js-scroll-trigger <?= ($index == 'berita') ? 'active' : '' ?>" href="<?= ($index == 'index') ? '#berita' : base_url('berita') ?>">Berita</a>
                </li>
                <li class="nav-item mx-0 mx-lg-1">
                    <a class="nav-link py-3 px-0 px-lg-3 rounded js-scroll-trigger <?= ($index == 'karir') ? 'active' : '' ?>" href="<?= ($index == 'index') ? '#karir' : base_url('karir') ?>">Karir</a>
                </li>
                <li class="nav-item mx-0 mx-lg-1">
    ...
    <script type="text/javascript">
        ...
        (function() {
            ...
            s1.async = true;
            s1.src = 'https://embed.tawk.to/5ed268908ee2956d73a60a17/default';
            s1.charset = 'UTF-8';
