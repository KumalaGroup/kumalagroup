...
<section class="portfolio" id="Lowongan">
    <div class="container">
        ...
        <?php if ($data) {
            foreach ($data as $v) : ?> <div class="row">
                    <div class="col-md-8">
                    ...
                    <div class="col-md-4 text-center" style="margin-bottom:10px;"> <a class="btn btn-l btn-outline-primary" href="#" data-toggle="modal" onclick="apply_data('<?= $v->posisi ?>');" data-target="#modal"> Apply </a> </div><br>
                </div>
            <?php endforeach;
        } else { ?>
            <div class="row">
