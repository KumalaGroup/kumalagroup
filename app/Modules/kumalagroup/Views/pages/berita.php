<?php if ($mod == "detail") : ?>
    <style>
        #detailb {
            background-image: url("<?= "$base_img/berita/$data->gambar" ?>");
    ...
    <!-- Header -->
    <div class="container">
        <section class="bg-primary text-white mb-0" id="detailb">
        </section>
    </div>
...
<?php else : ?>
    <section class="portfolio" id="beritadanpromo" style="margin-top:150px !important;">
        <div class="container">
            <h3 class="text-center text-secondary mb-0">Berita & Promo</h3>
            <br><br>
