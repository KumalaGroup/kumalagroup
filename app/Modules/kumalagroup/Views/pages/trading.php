    ...
    <section class="portfolio" id="unitbisnis">
        <div class="container">
            ...
            <div class="row text-center">
                ...
                <div class="col-md-3">
                    <br>
                    <div class="oc-item col-md-3"> <a href="<?= base_url() ?>/trading/eni"> <img src="<?= base_url() ?>/assets/baru/img/partner/15.png" alt="partner" width="150" height="150"> </a> </div>
                </div>
            ...
            <div class="row text-center">
                ...
                <div class="col-md-3">
                    <div class="oc-item col-md-3"> <a href="<?= base_url() ?>/trading/opartner"> <img src="<?= base_url() ?>/assets/baru/img/partner/7.png" alt="partner" width="300" height="300"> </a> </div>
                </div>
                <div class="col-md-1"></div>
            </div>
        </div>
