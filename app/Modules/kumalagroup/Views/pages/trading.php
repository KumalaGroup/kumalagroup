<?php if ($mod == "list") : ?> <section class="bg-primary text-white mb-0" id="tradingoil">
    ...
    <section class="portfolio" id="unitbisnis">
        <div class="container">
            <h4 class="text-center text-secondary mb-0">Oil</h4> <br>
            <div class="row text-center">
                <div class="col-md-1"></div>
                    <div class="col-md-3">
                        <div class="oc-item col-md-3"> <a href="<?= base_url() ?>/trading/fuchs"> <img src="<?= base_url() ?>/assets/baru/img/partner/6.png" alt="partner" width="250" height="150"> </a> </div>
                    </div>
                    <div class="col-md-3">
            ...
            <div class="row text-center">
                <div class="col-md-1"></div>
                    <div class="col-md-3">
                        <div class="oc-item col-md-3"> <a href="<?= base_url() ?>/trading/opartner"> <img src="<?= base_url() ?>/assets/baru/img/partner/7.png" alt="partner" width="300" height="500"> </a> </div>
                    </div>
                <div class="col-md-1"></div>
            ...
            <div class="row text-center">
                ...
                <div class="col-md-3">
                    <div class="oc-item col-md-3"> <a href="<?= base_url() ?>/trading/doublecoin"> <img src="<?= base_url() ?>/assets/baru/img/partner/9.jpeg" alt="partner" width="250" height="200"> </a> </div>
                </div>
                <div class="col-md-3">
