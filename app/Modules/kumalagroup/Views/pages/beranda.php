<header class="masthead bg-primary text-white text-center" style="padding-top: calc(3rem + 25px) !important;" id="home">
    <div class="bd-example">
        <div id="carouselExampleCaptions" class="carousel slide" data-ride="carousel">
            <ol class="carousel-indicators"> <?php foreach ($slider as $i => $v) : ?> <li data-target="#carouselExampleCaptions" class="<?= ($i == 0) ? "active" : "" ?>" data-slide-to="<?= $i++ ?>"></li><?php endforeach ?> </ol>
            <div class="carousel-inner"> <?php foreach ($slider as $i => $v) : ?> <div class="carousel-item <?= ($i == 0) ? "active" : "" ?>"> <a href="<?= $v->aksi ?>" target="_blank"> <img src="<?= base_url("assets/img_marketing/slider/$v->gambar") ?>" class="d-block w-100" alt="..." style="background-size: cover !important;">
...
<section class="bg-fourth text-white mb-0 animated zoomInUp delay-6s" id="subscribe">
    <div class="container ">
        <div class="row">
            ...
            <div class="col-md-2"> <button class="btn btn-xl btn-outline-light"> Subscribe </button> </div>
        </div><!-- <div class="text-center mt-4"> </div>-->
    </div>
</section>
<section class="mb-0" id="partner">
    <div class="container text-center animated zoomIn delay-7s">
        <h2 class="text-center text-secondary mb-0">Partner</h2> <br>
        <div class="row"> <?php foreach ($partner as $v) : ?> <div class="col-md-3 text-center animated zoomIn delay-7s"> <img src="<?= base_url("assets/img_marketing/partner/$v->gambar") ?>" alt="partner" width="250px !important" height="150px !important"> </div><?php endforeach ?> </div>
    </div>
</section>