<?php if ($mod == "list") : ?> <style>
    ...
    <section class="bg-primary text-white mb-0" id="listotomotifmas">
        <div class="container"> <br><br><br><br><!-- <h1 class="text-center text-white">MAZDA</h1> -->
    ...
    <section class="portfolio" id="unitbisnis">
        <div id="dealer" class="container">
                                ...
                                <div class="modal-content">
                                    ...
                                    <div class="modal-body">
                                        ...
                                        <div id="myTabContent" class="tab-content">
                                            <!-- <div class="tab-pane fade show active" id="home"> <h4>Pilih Lokasi Dealer dikota anda</h4> </div>-->
            ...
            <div class="row"> <?php foreach ($otomotif as $i => $v) : ?> <div class="col-md-4 p-3 mb-5">
                        <h4 class="text-center"><?= $v->model ?></h4> <img src="<?= "$base_img/otomotif/$v->gambar" ?>" width="100%" height="200" alt="" style="object-fit: cover;"> <br>
    ...
    <script>
        ...
        <!-- <div class="container mb-3"> <div class="content-wrap"> @if(session()->get('success')) <div class="alert alert-success">{{session()->get('success')}}</div><br/> @endif </div></div>-->
